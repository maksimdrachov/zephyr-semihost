...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ATMEL_SAM0_CAN_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ATMEL_SAMC2X_GCLK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ATMEL_SAMC2X_MCLK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_BOSCH_M_CAN_BASE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ATSAMC21N_XPRO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_SAMC21, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_SAM0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_SAMC21N18A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_REVISION_N, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZTEST_TC_UTIL_USER_OVERRIDE, 1);
